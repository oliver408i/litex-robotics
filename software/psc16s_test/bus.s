...
;
; GPIO_IN_OFF is the byte offset of psc16s_gpio_in within the CSR window --
...
;
; The constant pool looks like overkill here, and on THIS SoC it is: psc16s is
...
;
;   python3 tools/psc16s_asm.py software/psc16s_test/bus.s --py
;
; Expected: result == 42.
