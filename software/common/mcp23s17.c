...
#error "MCP23S17 driver needs the iox_reset/iox_inta CSRs -- build a SoC with the expander (add_mcp_expander, or add_aux_imu with_iox=True: targets/icepi_zero/mcp.py / targets/icepi_zero/mnist_lcd.py)."
#endif
